...
export default function TodoList() {
  ...
  */
  ...
  const onAddTodoClick = () => {
    console.log("clicked!")
    // Take the existing TodoList and append new item to it;
    ...
    const newTodos = [...todoList, todoText] // -> on add click, add text input to todoList
    setTodoList(newTodos)
    // campsite rules reset input field after submit
    setTodoText("")
  }
  ...
  return <Box sx={{ flexGrow: 1 }}>
      ...
      <Grid container spacing={2}>
        ...
        {/* Updating Grid to the new component API:
            - we don't need to specify an 'item' prop; Grid components are items by default 
            - we don't use xs (old shorthand/prop for horzontal size)
        */}
